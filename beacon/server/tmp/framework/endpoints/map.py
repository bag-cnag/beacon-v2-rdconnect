...
_datasets_proxy    = DatasetsParameters()
_cohorts_proxy     = CohortParameters()
...
# Datasets
query_datasets_by_dataset = handler.generic('datasets' , _datasets_proxy, fetch_datsets_by_dataset, build_dataset_response)
