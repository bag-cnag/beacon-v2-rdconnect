...
supported_schemas = {
    # default
    'beacon-info-v2.0.0-draft.4': default.beacon_info_v30,
    'beacon-dataset-v2.0.0-draft.4': default.beacon_dataset_info_v30,
    'beacon-variant-v2.0.0-draft.4': default.beacon_variant_v30,
    'beacon-variant-annotation-v2.0.0-draft.4': default.beacon_variant_annotation_v30,
    'beacon-biosample-v2.0.0-draft.4': default.beacon_biosample_v30,
    'beacon-individual-v2.0.0-draft.4': default.beacon_individual_v30,
    'beacon-cohort-v2.0.0-draft.4': default.beacon_cohort_v31,
    # alternative
